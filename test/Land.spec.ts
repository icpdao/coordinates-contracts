...
describe("LandNFT", async () => {
  ...
  it("buy and give to", async () => {
    ...
    await exceptBuyAndGiveTwoStep(landNFTToken, w1, w3, 2, -3, [[1, -2, w2.address]]);

    await exceptBuyAndGiveTwoStep(landNFTToken, w2, w4, 3, -4, []);
    await exceptBuyAndGiveTwoStep(landNFTToken, w2, w5, 4, -5, [[3, -4, w4.address]]);

    await exceptBuyAndGiveTwoStep(landNFTToken, w3, w6, 5, -6, []);
    await exceptBuyAndGiveTwoStep(landNFTToken, w3, w7, 6, -7, [[5, -6, w6.address]]);

    await exceptBuyAndGiveTwoStep(landNFTToken, w4, w8, 7, -8, []);
    await exceptBuyAndGiveTwoStep(landNFTToken, w4, w9, 8, -9, [[7, -8, w8.address]]);
