...
describe("PeopleLand.mintAndGiveToTwoStep", async () => {
  it("mint and give to", async () => {
    ...
    await exceptMintAndGiveTwoStep(landNFTToken, w1, w2, 111, -112, []);
    await exceptMintAndGiveTwoStep(landNFTToken, w1, w3, 112, -113, [
      [111, -112, w2.address],
    ]);
  ...
  it("mint not reserved", async () => {
    ...
    await exceptMintAndGiveTwoStep(landNFTToken, w2, w4, -130, 0, []);
    await exceptMintAndGiveTwoStep(landNFTToken, w2, w5, 130, 0, [
      [-130, 0, w4.address],
    ]);

    await exceptMintAndGiveTwoStep(landNFTToken, w3, w6, -31, 1, []);
    await exceptMintAndGiveTwoStep(landNFTToken, w3, w7, 31, 1, [
      [-31, 1, w6.address],
    ]);

    await exceptMintAndGiveTwoStep(landNFTToken, w4, w8, 1, -31, []);
    await exceptMintAndGiveTwoStep(landNFTToken, w4, w9, 1, 31, [
      [1, -31, w8.address],
    ]);
  ...
  it("mint cast eth", async () => {
    ...
    await exceptMintCost(PRICE, landNFTToken, 112, 112, w1, PRICE);
